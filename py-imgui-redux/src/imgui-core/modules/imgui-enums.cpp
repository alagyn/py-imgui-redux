...
void init_imgui_enums(py::module& m)
{
    ...
    ENUM(ImGui, ChildFlags)
        .RAW_VALUE(None_, ImGuiChildFlags_None)
        .VALUE(ImGui, ChildFlags, Borders)
        .VALUE(ImGui, ChildFlags, AlwaysUseWindowPadding)
        .VALUE(ImGui, ChildFlags, ResizeX)
        .VALUE(ImGui, ChildFlags, ResizeY)
        .VALUE(ImGui, ChildFlags, AutoResizeX)
        .VALUE(ImGui, ChildFlags, AutoResizeY)
        .VALUE(ImGui, ChildFlags, AlwaysAutoResize)
        .VALUE(ImGui, ChildFlags, FrameStyle)
        .VALUE(ImGui, ChildFlags, NavFlattened);

    ENUM(ImGui, ItemFlags)
        .RAW_VALUE(None_, ImGuiItemFlags_None)
        .VALUE(ImGui, ItemFlags, NoTabStop)
        .VALUE(ImGui, ItemFlags, NoNav)
        .VALUE(ImGui, ItemFlags, NoNavDefaultFocus)
        .VALUE(ImGui, ItemFlags, ButtonRepeat)
        .VALUE(ImGui, ItemFlags, AutoClosePopups)
        .VALUE(ImGui, ItemFlags, AllowDuplicateId);
    ...
    ENUM(ImGui, InputTextFlags)
        ...
        .VALUE(ImGui, InputTextFlags, ParseEmptyRefVal)
        .VALUE(ImGui, InputTextFlags, DisplayEmptyRefVal)
        .VALUE(ImGui, InputTextFlags, NoHorizontalScroll)
        .VALUE(ImGui, InputTextFlags, NoUndoRedo)
        // Elide display / Alignment
        .VALUE(ImGui, InputTextFlags, ElideLeft)
        // Callback features
    ...
    ENUM(ImGui, TreeNodeFlags)
        ...
        .VALUE(ImGui, TreeNodeFlags, AllowOverlap)
        ...
        .VALUE(ImGui, TreeNodeFlags, SpanFullWidth)
        .VALUE(ImGui, TreeNodeFlags, SpanLabelWidth)
        .VALUE(ImGui, TreeNodeFlags, SpanAllColumns)
        .VALUE(ImGui, TreeNodeFlags, LabelSpanAllColumns)
        .VALUE(ImGui, TreeNodeFlags, NavLeftJumpsToParent)
        .VALUE(ImGui, TreeNodeFlags, CollapsingHeader)
        .VALUE(ImGui, TreeNodeFlags, DrawLinesNone)
        .VALUE(ImGui, TreeNodeFlags, DrawLinesFull)
        .VALUE(ImGui, TreeNodeFlags, DrawLinesToNodes);
    ...
    ENUM(ImGui, PopupFlags)
        ...
        .VALUE(ImGui, PopupFlags, NoReopen)
    ...
    ENUM(ImGui, SelectableFlags)
        ...
        .VALUE(ImGui, SelectableFlags, NoAutoClosePopups)
    ...
    ENUM(ImGui, ComboFlags)
        ...
        .VALUE(ImGui, ComboFlags, WidthFitPreview)
    ...
    ENUM(ImGui, HoveredFlags)
        ...
        .VALUE(ImGui, HoveredFlags, AllowWhenOverlappedByItem)
        .VALUE(ImGui, HoveredFlags, AllowWhenOverlappedByWindow)
        ...
        .VALUE(ImGui, HoveredFlags, ForTooltip)
        .VALUE(ImGui, HoveredFlags, Stationary)
        .VALUE(ImGui, HoveredFlags, DelayNone)
    ...
    ENUM(ImGui, DragDropFlags)
        ...
        .VALUE(ImGui, DragDropFlags, PayloadAutoExpire)
        .VALUE(ImGui, DragDropFlags, PayloadNoCrossContext)
        .VALUE(ImGui, DragDropFlags, PayloadNoCrossProcess)
    ...
    */
    py::enum_<ImGuiKey>(m, "ImKey")
        ...
        .VALUE(ImGui, Key, AppBack)
        .VALUE(ImGui, Key, AppForward)
        .VALUE(ImGui, Key, Oem102)
        // Gamepad
    ...
    ENUM(ImGui, InputFlags)
        .RAW_VALUE(None_, ImGuiConfigFlags_None)
        .VALUE(ImGui, InputFlags, Repeat)
        .VALUE(ImGui, InputFlags, RouteActive)
        .VALUE(ImGui, InputFlags, RouteFocused)
        .VALUE(ImGui, InputFlags, RouteGlobal)
        .VALUE(ImGui, InputFlags, RouteAlways)
        .VALUE(ImGui, InputFlags, RouteOverFocused)
        .VALUE(ImGui, InputFlags, RouteOverActive)
        .VALUE(ImGui, InputFlags, RouteUnlessBgFocused)
        .VALUE(ImGui, InputFlags, RouteFromRootWindow)
        .VALUE(ImGui, InputFlags, Tooltip);
    ...
    ENUM(ImGui, BackendFlags)
        ...
        .VALUE(ImGui, BackendFlags, RendererHasTextures);
    ...
    ENUM(ImGui, Col)
        ...
        .VALUE(ImGui, Col, InputTextCursor)
        .VALUE(ImGui, Col, TabHovered)
        .VALUE(ImGui, Col, Tab)
        .VALUE(ImGui, Col, TabSelected)
        .VALUE(ImGui, Col, TabSelectedOverline)
        .VALUE(ImGui, Col, TabDimmed)
        .VALUE(ImGui, Col, TabDimmedSelected)
        .VALUE(ImGui, Col, TabDimmedSelectedOverline)
    ...
    ENUM(ImGui, StyleVar)
        ...
        .VALUE(ImGui, StyleVar, ImageRounding)
        ...
        .VALUE(ImGui, StyleVar, SeparatorTextBorderSize)
        .VALUE(ImGui, StyleVar, SeparatorTextAlign)
        .VALUE(ImGui, StyleVar, SeparatorTextPadding);
    ...
    ENUM(ImGui, ColorEditFlags)
        ...
        .VALUE(ImGui, ColorEditFlags, NoColorMarkers)
        // Alpha preview
        .VALUE(ImGui, ColorEditFlags, AlphaOpaque)
        .VALUE(ImGui, ColorEditFlags, AlphaNoBg)
    ...
    ENUM(ImGui, SliderFlags)
        ...
        .VALUE(ImGui, SliderFlags, WrapAround)
        .VALUE(ImGui, SliderFlags, ClampOnInput)
        .VALUE(ImGui, SliderFlags, ClampZeroRange)
        .VALUE(ImGui, SliderFlags, NoSpeedTweaks)
        .VALUE(ImGui, SliderFlags, ColorMarkers)
    ...
    ENUM(ImGui, MouseCursor)
        ...
        .VALUE(ImGui, MouseCursor, Wait)
        .VALUE(ImGui, MouseCursor, Progress)
        .VALUE(ImGui, MouseCursor, NotAllowed);

    ENUM(ImGui, MouseSource)
        .VALUE(ImGui, MouseSource, Mouse)
        .VALUE(ImGui, MouseSource, TouchScreen)
        .VALUE(ImGui, MouseSource, Pen);
    ...
    ENUM(ImGui, MultiSelectFlags)
        .RAW_VALUE(None_, ImGuiMultiSelectFlags_None)
        .VALUE(ImGui, MultiSelectFlags, SingleSelect)
        .VALUE(ImGui, MultiSelectFlags, NoSelectAll)
        .VALUE(ImGui, MultiSelectFlags, NoRangeSelect)
        .VALUE(ImGui, MultiSelectFlags, NoAutoSelect)
        .VALUE(ImGui, MultiSelectFlags, NoAutoClear)
        .VALUE(ImGui, MultiSelectFlags, NoAutoClearOnReselect)
        .VALUE(ImGui, MultiSelectFlags, BoxSelect1d)
        .VALUE(ImGui, MultiSelectFlags, BoxSelect2d)
        .VALUE(ImGui, MultiSelectFlags, BoxSelectNoScroll)
        .VALUE(ImGui, MultiSelectFlags, ClearOnEscape)
    ...
    ENUM(ImGui, SelectionRequestType)
        ...
        .VALUE(ImGui, SelectionRequestType, SetAll)
        .VALUE(ImGui, SelectionRequestType, SetRange);

    ENUM(ImGui, TextureFormat)
        .VALUE(Im, TextureFormat, RGBA32)
        .VALUE(Im, TextureFormat, Alpha8);

    ENUM(ImGui, TextureStatus)
        .VALUE(Im, TextureStatus, OK)
        .VALUE(Im, TextureStatus, Destroyed)
        .VALUE(Im, TextureStatus, WantCreate)
        .VALUE(Im, TextureStatus, WantUpdates)
        .VALUE(Im, TextureStatus, WantDestroy);

    ENUM(ImGui, FontFlags)
        .RAW_VALUE(None_, ImFontFlags_None)
